...
"""
struct Landsat9 <: AbstractSatellite end

bandnames(::Type{Landsat9}) = [:B1, :B2, :B3, :B4, :B5, :B6, :B7]

layernames(::Type{Landsat9}) = [bandnames(Landsat9)..., :blue, :green, :red, :nir, :swir1, :swir2, :QA]
...
dn_scale(::Type{Landsat9}) = 0.0000275f0

dn_offset(::Type{Landsat9}) = -0.2f0

function parse_layers(::Type{Landsat9}, dir::String)
    # Construct Regex
    band_regex = _band_regex(bandnames(Landsat9))
